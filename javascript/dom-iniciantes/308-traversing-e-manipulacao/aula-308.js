...
/* MANIPULACAO DE ELEMENTOS
    Como criar novos elementos, inserir e remover do DOM.
*/
...
const tituloOriginal = document.querySelector('h1');

const cloneTitulo = tituloOriginal.cloneNode(true);
const contatoSection = document.querySelector('.contato');
contatoSection.appendChild(cloneTitulo);
